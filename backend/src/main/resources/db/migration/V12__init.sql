...
create table if not exists media_metadata (
    ...
    constraint chk_media_metadata_size_bytes_nonnegative check (size_bytes is null or size_bytes >= 0),
    constraint chk_media_metadata_width_positive check (width is null or width > 0),
    constraint chk_media_metadata_height_positive check (height is null or height > 0),
    constraint chk_media_metadata_duration_nonnegative check (duration_ms is null or duration_ms >= 0)
);
